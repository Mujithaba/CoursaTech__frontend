            ...
            {module.lectures.map((lecture: any) => (
              <AccordionItem
                ...
                title={
                  ...
                  >
                    <span className="font-mono font-semibold">{lecture.title}</span>
                    {!isPurchased && <FaLock className="text-gray-800" />}
                  </motion.div>
                }
              >
                {isPurchased ? (
                  ...
                  >
                    ...
                    <div className="flex flex-col md:flex-row w-full gap-4">
                      {lecture.lectureVideo && (
                        <div className="w-full md:w-1/2">
                          <h3 className="text-sm font-mono font-semibold mb-2">Video</h3>
                          <video
                            src={lecture.lectureVideo}
                            controls
                      ...
                      {lecture.lecturePdf && (
                        <div className="w-full md:w-1/2">
                          <div className="flex items-center mb-2">
                            <h3 className="text-sm font-mono font-semibold">PDF:</h3>
                            <a
                              href={lecture.lecturePdf}
                              target="_blank"
                              rel="noopener noreferrer"
