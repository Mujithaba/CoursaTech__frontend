...
import { HiOutlineLogout ,HiOutlineCollection,HiOutlineChartSquareBar ,HiOutlinePlusCircle  } from "react-icons/hi";
    ...
    <aside className="bg-teal-900 text-white w-64 space-y-6 py-7 px-6 absolute inset-y-0 left-0">
      ...
      <nav className='font-sans font-semibold '>
        <NavLink
          ...
          className={({ isActive }) =>
            `flex items-center m-2 py-2.5 px-4 rounded-xl transition duration-200 ${isActive ? 'bg-gray-800 justify-center' : 'hover:bg-gray-800'}`
          }
        >
          {({ isActive }) => (
          <>
        ...
        <NavLink
          ...
          className={({ isActive }) =>
            `flex items-center py-2.5 m-2 px-4 rounded-xl transition duration-200 ${isActive ? 'bg-gray-800 justify-center' : 'hover:bg-gray-800'}`
          }
        >
{({ isActive }) => (
          <>
