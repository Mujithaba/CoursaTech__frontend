...
//       });
//     } catch (error) {
//       console.log("Fetching this course encountered an error. Please try again later.");
//     }
//   };
...
export default function EnrolledCourses({ userId }: EnrolledCoursesProps) {
  ...
  return (
    <Box 
      sx={{ 
        height: 'calc(100vh - 64px - 64px)', // Adjust based on your header and footer heights
        overflow: 'auto',
        backgroundColor: "#f5f5f5"
      }}
    >
