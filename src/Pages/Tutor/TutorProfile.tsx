...
const TutorProfile: React.FC = () => {
  ...
  const saveChangePassword = async(currentPassword: string, newPassword: string) => {
    ...
    try {
      ...
      const response = await updateTutorPassword(tutorInfo._id as string, currentPassword, newPassword);
      ...
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
        <div className="md:flex">
          ...
          <div className="p-8 flex-1">
            ...
            {showChangePassword ? (
              <ChangePassword
                onChangePassword={saveChangePassword}
              />
            ) : (
...
//   // saveChangePassword
//   const saveChangePassword = (currentPassword: string, newPassword: string) => {
//     console.log(
//       currentPassword,
//       newPassword,
...
//             {showChangePassword ? (
//               <ChangePassword
//                 currPassword={registerData?.password ?? ""}
//                 onChangePassword={saveChangePassword}
//               />
//             ) : (
//               <>
