        ...
        <section id="about" className="py-16 bg-gray-100">
          <div className="container mx-auto px-6 lg:px-12">
            ...
            >
              ...
              >
                <h3 className="text-2xl font-semibold text-gray-800">Expert Tutors</h3>
              ...
              <motion.div
                ...
                transition={{ type: "spring", stiffness: 200 }}
              >
                <h3 className="text-2xl font-semibold text-gray-800">Flexible Learning</h3>
                <p className="mt-4 text-gray-600">
              ...
              <motion.div
                ...
                transition={{ type: "spring", stiffness: 200 }}
              >
                <h3 className="text-2xl font-semibold text-gray-800">Interactive Lessons</h3>
                <p className="mt-4 text-gray-600">
