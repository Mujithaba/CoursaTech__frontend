...
const VideoCallRoomUser = lazy(
  () => import("../Components/Common/user/VideoCallRoomUser")
);
        ...
        <Routes>
          <Route element={<UserLayouts />}>
            ...
            <Route element={<UserProtected />}>
              ...
              <Route
                path="/videoCallRoomUser/:roomId"
                element={<VideoCallRoomUser />}
              />
            </Route>
          </Route>
